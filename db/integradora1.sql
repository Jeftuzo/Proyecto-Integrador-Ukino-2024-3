...
INSERT INTO `sys_config` VALUES ('diagnostics.allow_i_s_tables','OFF','2024-09-04 02:29:12',NULL),('diagnostics.include_raw','OFF','2024-09-04 02:29:12',NULL),('ps_thread_trx_info.max_length','65535','2024-09-04 02:29:12',NULL),('statement_performance_analyzer.limit','100','2024-09-04 02:29:12',NULL),('statement_performance_analyzer.view',NULL,'2024-09-04 02:29:12',NULL),('statement_truncate_len','64','2024-09-04 02:29:12',NULL);
...
-- Dump completed on 2024-12-03 18:56:30
-- MySQL dump 10.13  Distrib 8.0.38, for Win64 (x86_64)
--
-- Host: 127.0.0.1    Database: familia
-- ------------------------------------------------------
-- Server version	8.0.39
...
INSERT INTO `hijo` VALUES (1,'Pepe',10),(2,'Ramon',2),(3,'Aidin',4),(4,'Karlos',15),(5,'Karen',1);
...
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `papas` (
  `idpapa` int NOT NULL AUTO_INCREMENT,
  `nombre` varchar(45) NOT NULL,
  `edad` int DEFAULT NULL,
  `idhijo` int DEFAULT NULL,
  PRIMARY KEY (`idpapa`),
  KEY `idhijo` (`idhijo`),
  CONSTRAINT `idhijo` FOREIGN KEY (`idhijo`) REFERENCES `hijo` (`idhijo`)
...
INSERT INTO `papas` VALUES (23,'Maria',22,3),(24,'Juan',23,3),(25,'Daniela',26,5),(26,'Pedro',29,3),(27,'Perla',35,1),(28,'Pablo',32,3),(29,'karla',23,1),(30,'Felix',27,3),(31,'Paulina',31,4),(32,'Jose',37,5);
...
CREATE TABLE `combinaciones` (
  ...
  `multiplexor` varchar(45) DEFAULT NULL,
  `demultiplexor` varchar(45) DEFAULT NULL,
  `idpagina` int DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `paginas_idx` (`idpagina`),
  KEY `idpagina_idx` (`idpagina`),
  CONSTRAINT `idpagina` FOREIGN KEY (`idpagina`) REFERENCES `paginas` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `conceptos` VALUES (1,'POO II','Programacion orientada a objetos II','es la que me plasca'),(2,'ED','Ecuaciones diferenciales','es la que me plasca1'),(3,'Elect','Electronica digital','lo que sea'),(4,'BD','base de datos','lo que sea');
...
CREATE TABLE `login` (
  ...
  CONSTRAINT `usuarioss` FOREIGN KEY (`usuario`) REFERENCES `usuario` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `usuario` (
  ...
  `contraseña` varchar(5000) NOT NULL,
...
INSERT INTO `usuario` VALUES (1,'patata','patata@correo.com','$5$rounds=535000$zvv592chmpkM64Ow$tWYPh7siVqw9C0OXlMr.w2PvbzWN06sp/m0fTCo136.','1');
...
CREATE TABLE `alumno` (
  ...
  KEY `plantel_idx` (`carrera`),
  KEY `plantel_idx1` (`plantel`),
  KEY `materia_idx` (`materia`),
  CONSTRAINT `carrera` FOREIGN KEY (`carrera`) REFERENCES `plantel` (`idplantel`) ON UPDATE CASCADE,
  CONSTRAINT `materia` FOREIGN KEY (`materia`) REFERENCES `materias` (`idMateria`),
  CONSTRAINT `plantel` FOREIGN KEY (`plantel`) REFERENCES `plantel` (`idplantel`) ON UPDATE CASCADE
...
INSERT INTO `alumnos` VALUES (1,'Pedro','',0,0,NULL),(2,'Pedro','',0,0,NULL);
...
CREATE TABLE `materias` (
  ...
  `idSemstre` int NOT NULL,
  `idHorario` int NOT NULL,
  PRIMARY KEY (`idMateria`),
  KEY `idPlantel_idx` (`idPlantel`),
  KEY `idSemstre_idx` (`idSemstre`),
  KEY `idHorario_idx` (`idHorario`),
  CONSTRAINT `idHorario` FOREIGN KEY (`idHorario`) REFERENCES `horarios` (`idHorario`),
  CONSTRAINT `idPlantel` FOREIGN KEY (`idPlantel`) REFERENCES `plantel` (`idplantel`),
  CONSTRAINT `idSemstre` FOREIGN KEY (`idSemstre`) REFERENCES `semestre` (`idsemestre`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;
